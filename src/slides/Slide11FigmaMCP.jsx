  ...
  return (
    <SlideShell isActive={isActive}>
      <SlideInner isActive={isActive}>
        ...
        <SlideBody>
          MCP is a plugin system that lets Claude Code connect to other tools. The Figma MCP lets Claude Code read your Figma files &mdash; layers, styles, layout, components.
        </SlideBody>
        <FlowDiagram />
        <SlideBody>
          You can say <strong>&ldquo;look at this Figma frame and build it&rdquo;</strong> and Claude Code will reference the actual design, not just your description of it.
        </SlideBody>
