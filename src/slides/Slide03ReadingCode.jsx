...
export default function Slide03ReadingCode({ isActive }) {
  return (
    <SlideShell isActive={isActive} className="justify-start pt-32 max-md:pt-24">
      <SlideInner isActive={isActive}>
        ...
        <SlideBody>
          You don't need to <em>write</em> code, but it helps to be able to <strong>scan it</strong> enough make small changes.
        </SlideBody>
        ...
        <SlideBody style={{ marginTop: '1.5rem' }}>
          The code snippet above uses regular CSS, but you'll also commonly see <strong>Tailwind CSS</strong> &mdash; a popular shorthand for styling. Instead of writing <code>padding: 24px</code>, you write <code>p-6</code> directly on the element. Same concepts, shorter names.
        </SlideBody>
        <Callout>
